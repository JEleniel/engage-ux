//! Layout implementation. Primary types: `Layout`, `CalculatedBounds`.

use serde::{Deserialize, Serialize};

// re-exported types (used by other layout submodules)
#[allow(unused_imports)]
pub use super::constraints::Constraints;
#[allow(unused_imports)]
pub use super::position::{Position, PositionMode};
#[allow(unused_imports)]
pub use super::size::{Size, SizeMode};
#[allow(unused_imports)]
pub use super::units::{RelativeUnit, Unit};
